<div class="header-mobile header_sticky">
    ...
    <nav
      class="header-mobile__navigation navigation d-flex flex-column w-100 position-absolute top-100 bg-body overflow-auto navbar">
      <div class="container">
        ...
        <div class="overflow-hidden">
          <ul class="navigation__list list-unstyled position-relative">
            <li class="navigation__item">
              <a href="{{route('pages.index')}}" class="navigation__link navbar-brand">Home</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.shop.index') }}" class="navigation__link navbar-brand">Shop</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.cart.index') }}" class="navigation__link navbar-brand">Cart</a>
            </li>
            <li class="navigation__item">
              <a href="about.html" class="navigation__link navbar-brand">About</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.contact') }}" class="navigation__link navbar-brand">Contact</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="header-desk header-desk_type_1">
        ...
        <nav class="navigation">
          <ul class="navigation__list list-unstyled d-flex nav-item">
            <li class="navigation__item">
              <a href="{{route('pages.index')}}" class="navigation__link ">Home</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.shop.index') }}" class="navigation__link ">Shop</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.cart.index') }}" class="navigation__link ">Cart</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.about') }}" class="navigation__link ">About</a>
            </li>
            <li class="navigation__item">
              <a href="{{ route('pages.contact') }}" class="navigation__link ">Contact</a>
            </li>
          </ul>
        </nav>
        ...
        <div class="header-tools d-flex align-items-center">
          ...
          @else                    
            <div class="header-tools__item hover-container">
              <a class="header-tools__item" href="{{ Auth::user()->role=='admin' ? route('admin.index') : route('pages.account')}}">
                <span class="pr-6px" style="color:white;">{{ Auth::check() ? Auth::user()->name : 'Guest' }}</span>
                <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <use href="#icon_user" />
                </svg>
              </a>
          ...
          <a href="{{ route('pages.cart.index') }}" class="header-tools__item header-tools__cart">
            <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <use href="#icon_cart" />
            </svg>
                                ...
                                let dropdown = $('#search-results');
                                  ...
                                  if (data.length > 0) {
                                    data.forEach(function (product) {
                                        let url="{{ route('pages.shop.product.details',['product_slug'=>'slug']) }}";
