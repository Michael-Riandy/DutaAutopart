  ...
  <footer class="footer footer_type_2">
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
          <div class="logo">
            <a href="index.html">
              <img src="assets/images/about/about-2.jpg" alt="" class="logo__image d-block" />
            </a>
          </div>
          <p class="footer-address">Jl. Adi Sucipto, Bangka Belitung Laut, Kec. Pontianak Tenggara,<br> Kota Pontianak, Kalimantan Barat 78111</p>
          <p class="m-0"><strong class="fw-medium">dutaautopart@gmail.com</strong></p>
          <p><strong class="fw-medium">082154822228</strong></p>
    ...
    <div class="footer-bottom">
      <div class="container d-md-flex align-items-center">
        <span class="footer-copyright me-auto">©2025 Duta Autopart</span>
