      ...
      <div class="row">
              ...
              <div class="swiper-container">
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide product-single__image-item">
                    <img loading="lazy" class="" src="{{ asset('uploads/products')}}/{{ $product->image }}" width="100%"height="500" style="object-fit: cover" alt="" />
        ...
        <div class="col-lg-5">
          ...
          <div class="product-single__price">
            <span class="current-price">Rp. {{ $product->price }}</span>
          </div>
          <div class="product-single__short-desc">
            <p>{{$product->description}}</p>
          </div>
          @if(Cart::instance('cart')->content()->where('id',$product->id)->count()>0)
          <a href="{{ route('pages.cart.index') }}" class="btna btn-warning mb-3">Go to Cart</a>
          @else
          <form name="addtocart-form" method="post" action="{{ route('pages.cart.store') }}">
            ...
            <div class="product-single__addtocart">
              ...
              <button type="submit" class="btna btn-primary btn-addtocart" data-aside="cartDrawer">Add to
                Cart</button>
            </div>
          </form>
          @endif
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide product-card">
                <div class="pc__img-wrapper">
                    <a href="{{ route('pages.shop.product.details',['product_slug'=>$rproduct->slug]) }}">
                    ...
                    @if(Cart::instance('cart')->content()->where('id',$rproduct->id)->count()>0)
                      <a href="{{ route('pages.cart.index') }}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">Go to Cart</a>
                    @else
                    <form name="addtocart-form" method="post" action="{{ route('pages.cart.store') }}">
                      @csrf
                ...
                <div class="pc__info position-relative">
                    ...
                    <h6 class="pc__title"><a href="{{ route('pages.shop.product.details',['product_slug'=>$rproduct->slug]) }}">{{$rproduct->name}}</a></h6>
                    <div class="product-card__price d-flex">
                        <span class="money price">Rp. {{$rproduct->price}}</span>
                    </div>
                </div>
            </div> 
            @endforeach
